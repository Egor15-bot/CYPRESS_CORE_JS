...
Мы не храним логины, пароли и токены авторизации прямо в коде!
...
as-a preprod npx cypress open - запуск всех тестов используя настройки [preprod] из файла `.as-a.ini`
```
