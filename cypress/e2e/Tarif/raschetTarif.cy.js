describe('', () => {
    ...
    it('#3507 - Градусники расчетный',() =>{
        cy.get('section.tariff-details-container').within(() =>{
            ...
            cy.get(':nth-child(4) > .tariff-details-item__header').should('contain',' 25 ₽ за платеж ')
            ...
            cy.get('[data-qa="16577853554320"] > .tariff-details-item > .tariff-details-item__progress-wrapper > span').should('contain',' 0 шт ')
            cy.get(':nth-child(2) > .tariff-details-item__header').should('contain',' Счет: ')
                .find('span').should('contain','  Расчетный счет 40702810200990004093 ')       
            ...
            cy.get(':nth-child(3) > .tariff-details-item__header').should('contain',' 0.2% ')
